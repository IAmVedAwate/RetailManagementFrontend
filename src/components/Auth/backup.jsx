...
const CreateAccount = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const formPayload = {
        role: formData.role,
        storeName: formData.roleData?.storeName || "",
        adminName: formData.name || "",
        retailName: formData.roleData?.retailName || "",
        deliveryUserName: formData.name || "",
        ownerName: formData.name || "",
        name: formData.name,
        username: formData.username,
        email: formData.username,
        address: formData.roleData?.address,
        phone: formData.phone,
        password: formData.password,
        adhar: formData.roleData?.adhar || "",
        gstNumber: formData.roleData?.gstNumber || "",
        profilePhoto: "",
        photoOfStore: "",
      };
